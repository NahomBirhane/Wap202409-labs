...
const App = () => {
  ...
  const sortedCommentList = selectedTab === 'hot'
    ? _.sortBy(commentList, ['like']).reverse() // Sort by likes for 'Top'
    : _.sortBy(commentList, [(comment) => comment.isoCtime ? new Date(comment.isoCtime) : new Date(comment.ctime)]).reverse(); // Sort by ISO time for 'Newest'
        ...
        <ul className="nav-bar">
          ...
          <li className="nav-sort">
            {tabs.map((tab) => (
              <span
                key={tab.type}
                className={`nav-item ${selectedTab === tab.type ? 'active' : ''}`}
        ...
        <div className="box-normal">
          ...
          <div className="reply-box-wrap">
            ...
            <div className="reply-box-send">
              <div className="send-text" onClick={handlePostComment}>
                Post
              </div>
            </div>
          </div>
                ...
                <div className="root-reply">
                  ...
                  <div className="reply-info">
                    ...
                    {comment.user.uid === user.uid && (
                      <span className="delete-btn" onClick={() => handleDeleteComment(comment.rpid)}>
                        Delete
                      </span>
                    )}
                  </div>
